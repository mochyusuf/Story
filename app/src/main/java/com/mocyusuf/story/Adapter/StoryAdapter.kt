package com.mocyusuf.story.Adapter
...
import com.mocyusuf.story.Activity.Detail
import com.mocyusuf.story.Local.Entity.Story
import com.mocyusuf.story.R
import com.mocyusuf.story.Utils.DateFormatter
import com.mocyusuf.story.databinding.ItemStoryBinding
import java.util.*
        ...
        fun bind(context: Context,story: Story) {
            binding.apply {
                ...
                root.setOnClickListener {
                    ...
                    Intent(context, Detail::class.java).also { intent ->
                        intent.putExtra(Detail.EXTRA_ITEM, story)
